...
\r
    ...
    <div class="education-content">\r
        ...
        <app-card icon="award" title="TDD With Spring Boot Done Right">\r
            ...
            <a class="anchor-unstyled" target="_blank" href="files/TDDWithSpringBootDoneRight.pdf">Download</a>\r
        ...
        <app-card icon="award" title="Docker & Kubernetes: The Practical Guide">\r
            ...
            <a class="anchor-unstyled" target="_blank" href="files/DockerKubernetes.pdf">Download</a>\r
...
</div>`;class D extends HTMLElement{connectedCallback(){this.innerHTML=`<style>${H}</style>${I}`,this.#e()}#e(){const e=this.getAttribute("skill"),t=this.getAttribute("percentage");!e||!t||(this.querySelector(".skill-name").innerHTML=e,this.querySelector(".skill-percentage").innerHTML=`${t}%`,this.querySelector(".skill-progress-bar").style.width=`${t}%`)}}customElements.define("app-skill",D);const j=".skills-section{display:flex;align-items:center;justify-content:center;padding:20px;box-sizing:border-box;word-break:break-word}.skills-content{width:var(--content-max-width);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px}.skills-header{margin:0;font-size:clamp(2rem,8vw,4rem);line-height:1.2;max-width:100%;text-align:center}.skills-subheader{margin:0;max-width:600px;width:100%;line-height:1.6;text-align:center}.skills-wrapper{width:100%;display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:20px;align-items:stretch}",B=`<section class="skills-section">\r
